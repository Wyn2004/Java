...
public class test {
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("10. Print list student to file.");
			System.out.println("11. Read file student.");
